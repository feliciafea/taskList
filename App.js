...
import { Alert, Button, StyleSheet, Text, TextInput, View, Modal, FlatList, SafeAreaView, TouchableOpacity } from 'react-native';
      ...
      <Modal visible={isModalVisible} transparent={true} onRequestClose={() => setIsModalVisible(!isModalVisible)}>
        <View style={styles.centeredView} >
          <View style={styles.modalView}> 
            ...
            <Button title='AYY Todo' onPress={addNewTodo} />
          </View>
        </View>
      </Modal>
